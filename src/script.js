...
const normalTexture = textureLoader.load("/textures/MoonNormalMap.jpg");
...
const pointLight2 = new THREE.PointLight(0xd4beb0, 2);
pointLight2.position.set(-7, 5.5, 0.68);
pointLight2.intensity = 0.71;
...
const pointLight3 = new THREE.PointLight("white", 2);
pointLight3.position.set(-1.3, 1.12, 10);
pointLight3.intensity = 0.04;
...
const updateSphere = (event) => {
	sphere.position.y = window.scrollY * 0.0003;
};
...
const tick = () => {
	...
	// sphere.position.z = -0.8 / elapsedTime;
